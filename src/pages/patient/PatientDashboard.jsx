          ...
          <div className="lg:w-[50%] sm:w-full border-2 border-primary-100 rounded-lg">
            <div className="w-full p-5 flex flex-row items-center justify-between">
              <div className="">
                ...
                <div className="mt-10">
                 <Link to={"/book-appointment"} className="p-3 text-center bg-primary-100 text-white capitalize font-medium rounded-lg lg:text-md sm:text-xs">book an appointment</Link>
                </div>
              </div>

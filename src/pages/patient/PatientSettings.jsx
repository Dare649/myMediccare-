...
const PatientSettings = () => {
  ...
  return (
    <section className="settings w-full sm:mt-10 lg:mt-20 h-screen lg:p-5 sm:p-0">
      <div onClick={handleOpenAddAccount} className="flex items-end justify-end mt-14 lg:px-10 sm:px-2">
        <button className="bg-primary-100 text-white hover:bg-transparent hover:border-2 hover:border-x-primary-100 hover:text-primary-100 font-bold lg:text-xl sm:text-md rounded-lg capitalize p-3 ">add account</button>
      </div>

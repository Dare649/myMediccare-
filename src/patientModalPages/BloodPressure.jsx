        ...
        <div className="lg:w-[50%] sm:w-full bg-white rounded-lg">
                ...
                <div className="flex flex-row items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="mt-2 capitalize font-semibold text-neutral-50">Help us monitor your vitals.</p>
                        </div>
                    </div>
            ...
            <form onSubmit={handleSubmit} className="p-5">
                ...
                <div className="bookAppointment w-full text-center my-2">
                    ...
                    >
                        {loading ? <CircularProgress size={25} color="inherit" /> : "Submit Blood Pressure"}
                    </button>
                </div>
                <div className="text-center font-bold capitalize text-primary-100 hover:underline cursor-pointer mt-4" onClick={handleCancel}>
                    Cancel
                </div>
            </form>
        </div>
